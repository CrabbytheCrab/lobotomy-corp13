...
SUBSYSTEM_DEF(lobotomy_corp)
	...
	var/list/ordeal_timelock = list(10 MINUTES, 30 MINUTES, 60 MINUTES, 90 MINUTES, 0, 0, 0, 0, 0)
...
/datum/controller/subsystem/lobotomy_corp/proc/RollOrdeal()
	...
	next_ordeal_time = max(5, qliphoth_state + next_ordeal.delay + (next_ordeal.random_delay ? rand(-0.5, 1.5) : 0))
