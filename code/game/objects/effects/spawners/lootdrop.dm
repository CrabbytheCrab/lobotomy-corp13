...
/obj/effect/spawner/lootdrop/space/syndiecosmetic
	lootcount = 2
	loot = list(
		/obj/item/clothing/under/mercenary = 10,
		/obj/item/clothing/under/mercenary/skirt = 10,
		/obj/item/clothing/under/mercenary/bloodred = 10,
		/obj/item/clothing/under/mercenary/bloodred/sleepytime = 5,
		/obj/item/clothing/under/mercenary/tacticool = 10,
		/obj/item/clothing/under/mercenary/tacticool/skirt = 10,
		/obj/item/clothing/under/mercenary/sniper = 10,
		/obj/item/clothing/under/mercenary/camo = 10,
		/obj/item/clothing/under/mercenary/soviet = 10,
		/obj/item/clothing/under/mercenary/combat = 10,
		/obj/item/clothing/under/mercenary/rus_army = 10,
