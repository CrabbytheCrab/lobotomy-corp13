...
/obj/item/clothing/suit/armor/ego_gear/realization/confessional
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 100, BLACK_DAMAGE = 50, PALE_DAMAGE = 40)	//Ranged, 240
...
/obj/item/clothing/suit/armor/ego_gear/realization/maiden
	...
	icon_state = "maiden"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 60, BLACK_DAMAGE = 80, PALE_DAMAGE = 60)	//No ability. 260
...
/obj/item/clothing/suit/armor/ego_gear/realization/comatose
	...
	desc = "...ZZZ..."
	icon_state = "comatose"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 10, BLACK_DAMAGE = 40, PALE_DAMAGE = 60)	//Defensive
...
/obj/item/clothing/suit/armor/ego_gear/realization/universe
	...
	icon_state = "universe"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 40, BLACK_DAMAGE = 80, PALE_DAMAGE = 70)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/sakura_bloom
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 80, BLACK_DAMAGE = 40, PALE_DAMAGE = 50)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/bigiron
	...
	icon_state = "big_iron"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 60, BLACK_DAMAGE = 60, PALE_DAMAGE = 60)		//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/eulogy
	...
	icon_state = "eulogy"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 80, BLACK_DAMAGE = 80, PALE_DAMAGE = 50)		//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/ourgalaxy
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 70, BLACK_DAMAGE = 80, PALE_DAMAGE = 50)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/forever
	...
	icon_state = "forever"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 80, BLACK_DAMAGE = 70, PALE_DAMAGE = 70)		//No ability
...
/obj/item/clothing/suit/armor/ego_gear/realization/home //This name would SO much easier if we didnt aleady USE HOMING INSTINCT AHHHHHHHHHHHHHHHHHHH
	...
	icon_state = "home"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 70, BLACK_DAMAGE = 80, PALE_DAMAGE = 60)		//Support
	flags_inv = HIDEGLOVES|HIDESHOES
...
/obj/item/clothing/suit/armor/ego_gear/realization/dimension_ripper
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 50, BLACK_DAMAGE = 70, PALE_DAMAGE = 40)		//Melee
...
/obj/item/clothing/suit/armor/ego_gear/realization/quenchedblood
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 70, BLACK_DAMAGE = 40, PALE_DAMAGE = 90)		//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/woundedcourage
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 20, BLACK_DAMAGE = 80, PALE_DAMAGE = 70)		//Melee
	flags_inv = HIDEJUMPSUIT | HIDEGLOVES | HIDESHOES
...
/obj/item/clothing/suit/armor/ego_gear/realization/nest
	...
	icon_state = "nest"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 50, PALE_DAMAGE = 50)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/alcoda
	...
	icon_state = "coda"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 100, BLACK_DAMAGE = 70, PALE_DAMAGE = 20)		//No Ability
...
/obj/item/clothing/suit/armor/ego_gear/realization/laughter
	...
	icon_state = "laughter"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 50, BLACK_DAMAGE = 80, PALE_DAMAGE = 50)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/farmwatch
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 70, BLACK_DAMAGE = 60, PALE_DAMAGE = 60)
...
/obj/item/clothing/suit/armor/ego_gear/realization/gasharpoon
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 70, BLACK_DAMAGE = 30, PALE_DAMAGE = 80)//240, required for the corresponding weapon abilities
